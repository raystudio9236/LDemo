...
namespace RayStudio.UtilScripts.Utils
{
    public class FileHelper
    {
        ...
        public static bool Write(byte[] content, string fileName)
        {
            ...
            {
                Debug.LogError($"Write failed! path = {fileName} with err = {e.Message}");
                return false;
            }
        }
        ...
        public static byte[] ReadAllBytes(string path)
        {
            ...
            {
                Debug.LogError($"ReadAllBytes failed! path = {path} with err = {e.Message}");
                return null;
            }
        }
